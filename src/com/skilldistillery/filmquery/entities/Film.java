...
public class Film {
	...
	@Override
	public int hashCode() {
		return Objects.hash(cast, descriptionOffilm, filmId, language, length, rating, releaseYear, rental_duration,
				rental_rate, replacementCost, specialFeatures, title);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Film other = (Film) obj;
		return Objects.equals(cast, other.cast) && Objects.equals(descriptionOffilm, other.descriptionOffilm)
